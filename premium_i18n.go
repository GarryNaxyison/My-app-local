...
func englishPremiumUICopy() premiumUICopy {
	return premiumUICopy{
		...
		InviteFree:                  "Invite friends: they get 7 free days of Premium, you get 7 days Premium when they reach level 3, plus referral balance from purchases",
		...
		InviteLinkText:              "Start learning with NERIVA:\n%s\n\nNERIVA connects the Telegram bot and web app into one AI language coach: bite-size lessons, speaking practice, vocabulary review, translator, voice-to-text, and photo translation.\n\nOpen the link to get a free week of Premium.",
		ReferralShareText:           "Start learning with NERIVA:\n%s\n\nNERIVA connects the Telegram bot and web app into one AI language coach: bite-size lessons, speaking practice, vocabulary review, translator, voice-to-text, and photo translation.\n\nOpen the link to get a free week of Premium.",
		...
		ReferralInvitee:             "You joined by invitation and received 7 free days of Premium. Your friend will receive 7 days of Premium when you reach level 3.",
		ReferralBalanceTitle:        "Referral balance",
		ReferralInvitationsLabel:    "Invitations",
		ReferralBalanceHint:         "20% from direct referrals and 5% from their referrals. Withdrawal is available from 1000 ₽.",
		ReferralWithdrawButton:      "Withdraw",
		ReferralWithdrawUnavailable: "Withdrawal is available from 1000 ₽. Your balance: %s.",
...
var premiumUICopyOverrides = map[string]premiumUICopy{
	"ru": {
		...
		InviteFree:                  "Приглашай друзей: им 7 дней Premium бесплатно, тебе 7 дней Premium, когда друг достигнет 3 уровня, и баланс с покупок",
		...
		InviteLinkText:              "Начни заниматься с NERIVA:\n%s\n\nNERIVA объединяет Telegram-бота и web app в одного AI-репетитора: короткие уроки, разговорная практика, повторение слов, переводчик, голос в текст и перевод текста с фото.\n\nОткрой ссылку и получи неделю Premium бесплатно.",
		ReferralShareText:           "Начни заниматься с NERIVA:\n%s\n\nNERIVA объединяет Telegram-бота и web app в одного AI-репетитора: короткие уроки, разговорная практика, повторение слов, переводчик, голос в текст и перевод текста с фото.\n\nОткрой ссылку и получи неделю Premium бесплатно.",
		...
		ReferralInvitee:             "Ты пришел по приглашению и получил 7 дней Premium бесплатно. Друг получит 7 дней Premium, когда ты достигнешь 3 уровня.",
		ReferralBalanceTitle:        "Реферальный баланс",
		ReferralInvitationsLabel:    "Приглашений",
		ReferralBalanceHint:         "20% с прямых приглашений и 5% со второго уровня. Вывод доступен от 1000 ₽.",
		ReferralWithdrawButton:      "Вывод",
		ReferralWithdrawUnavailable: "Вывод доступен от 1000 ₽. Твой баланс: %s.",
...
var referralShareTextByInterfaceLanguage = map[string]string{
	"en": "Start learning with NERIVA:\n%s\n\nNERIVA connects the Telegram bot and web app into one AI language coach: bite-size lessons, speaking practice, vocabulary review, translator, voice-to-text, and photo translation.\n\nOpen the link to get a free week of Premium.",
	"ru": "Начни заниматься с NERIVA:\n%s\n\nNERIVA объединяет Telegram-бота и web app в одного AI-репетитора: короткие уроки, разговорная практика, повторение слов, переводчик, голос в текст и перевод текста с фото.\n\nОткрой ссылку и получи неделю Premium бесплатно.",
	"es": "Prueba NERIVA:\n%s\n\nNERIVA es un bot de Telegram y una versión web para aprender idiomas con AI: lecciones cortas, práctica de conversación, vocabulario, traductor, voz a texto y traducción de texto en fotos.\n\nAbre este enlace y recibirás 7 días de suscripción Premium en el bot.",
	"de": "Probiere NERIVA aus:\n%s\n\nNERIVA ist ein Telegram-Bot und eine Web-Version zum Sprachenlernen mit AI: kurze Lektionen, Gesprächspraxis, Worttraining, Übersetzer, Sprache-zu-Text und Übersetzung von Text auf Fotos.\n\nÖffne diesen Link und du erhältst 7 Tage Premium im Bot.",
	"fr": "Essaie NERIVA :\n%s\n\nNERIVA est un bot Telegram et une version web pour apprendre les langues avec AI : courtes leçons, pratique de conversation, vocabulaire, traducteur, voix en texte et traduction du texte des photos.\n\nOuvre ce lien et tu recevras 7 jours d'abonnement Premium dans le bot.",
	"it": "Prova NERIVA:\n%s\n\nNERIVA è un bot Telegram e una versione web per imparare le lingue con AI: lezioni brevi, pratica di conversazione, vocaboli, traduttore, voce in testo e traduzione del testo nelle foto.\n\nApri questo link e riceverai 7 giorni di abbonamento Premium nel bot.",
	"pt": "Experimenta o NERIVA:\n%s\n\nO NERIVA é um bot do Telegram e uma versão web para aprender idiomas com AI: lições curtas, prática de conversa, vocabulário, tradutor, voz para texto e tradução de texto em fotos.\n\nAbre este link e receberás 7 dias de assinatura Premium no bot.",
	"pl": "Wypróbuj NERIVA:\n%s\n\nNERIVA to bot Telegram i wersja web do nauki języków z AI: krótkie lekcje, praktyka rozmowy, słownictwo, tłumacz, głos na tekst i tłumaczenie tekstu ze zdjęć.\n\nOtwórz ten link, a otrzymasz 7 dni subskrypcji Premium w bocie.",
	"ro": "Încearcă NERIVA:\n%s\n\nNERIVA este un bot Telegram și o versiune web pentru învățarea limbilor cu AI: lecții scurte, practică de conversație, vocabular, traducător, voce în text și traducerea textului din fotografii.\n\nDeschide acest link și vei primi 7 zile de abonament Premium în bot.",
	"uk": "Спробуй NERIVA:\n%s\n\nNERIVA - це Telegram-бот і веб-версія для вивчення мов з AI: короткі уроки, розмовна практика, тренування слів, перекладач, голос у текст і переклад тексту з фото.\n\nВідкрий це посилання й отримай 7 днів Premium-підписки в боті.",
	"kk": "NERIVA-ды байқап көр:\n%s\n\nNERIVA - AI арқылы тіл үйренуге арналған Telegram боты және web нұсқасы: қысқа сабақтар, сөйлесу практикасы, сөз жаттығулары, аудармашы, дауысты мәтінге айналдыру және фотодағы мәтінді аудару.\n\nОсы сілтемені ашсаң, ботта 7 күн Premium жазылымын аласың.",
	"ky": "NERIVA'ды байкап көр:\n%s\n\nNERIVA - AI менен тил үйрөнүү үчүн Telegram боту жана web нускасы: кыска сабактар, сүйлөшүү практикасы, сөз машыгуулары, котормочу, үндү текстке айлантуу жана сүрөттөгү текстти которуу.\n\nБул шилтемени ачсаң, ботто 7 күн Premium жазылуусун аласың.",
	"ka": "სცადე NERIVA:\n%s\n\nNERIVA არის Telegram ბოტი და web ვერსია AI-ით ენების სასწავლად: მოკლე გაკვეთილები, საუბრის პრაქტიკა, სიტყვების ვარჯიში, თარჯიმანი, ხმის ტექსტად გადაყვანა და ფოტოზე ტექსტის თარგმნა.\n\nგახსენი ეს ბმული და ბოტში მიიღებ 7 დღიან Premium გამოწერას.",
	"uz": "NERIVA'ni sinab ko‘ring:\n%s\n\nNERIVA - AI bilan til o‘rganish uchun Telegram boti va web versiya: qisqa darslar, suhbat mashqi, so‘zlar, tarjimon, ovozni matnga aylantirish va rasmdagi matnni tarjima qilish.\n\nUshbu havolani oching va botda 7 kunlik Premium obunasini oling.",
	"tt": "NERIVA'ны сынап кара:\n%s\n\nNERIVA - AI белән тел өйрәнү өчен Telegram боты һәм web версиясе: кыска дәресләр, сөйләшү күнегүе, сүзләр, тәрҗемәче, тавышны текстка әйләндерү һәм фотодагы текстны тәрҗемә итү.\n\nБу сылтаманы ачсаң, ботта 7 көнлек Premium язылуын аласың.",
	"tg": "NERIVA-ро санҷед:\n%s\n\nNERIVA - боти Telegram ва версияи web барои омӯзиши забонҳо бо AI аст: дарсҳои кӯтоҳ, машқи гуфтугӯ, луғат, тарҷумон, овоз ба матн ва тарҷумаи матн аз акс.\n\nИн пайвандро кушоед ва дар бот 7 рӯзи обунаи Premium мегиред.",
	"hy": "Փորձիր NERIVA-ը:\n%s\n\nNERIVA-ը Telegram բոտ և web տարբերակ է AI-ով լեզուներ սովորելու համար՝ կարճ դասեր, խոսակցական պրակտիկա, բառերի մարզում, թարգմանիչ, ձայնը տեքստի վերածում և լուսանկարների տեքստի թարգմանություն։\n\nԲացիր այս հղումը և բոտում կստանաս Premium բաժանորդագրություն 7 օրով։",
	"zh": "试试 NERIVA：\n%s\n\nNERIVA 是一个用 AI 学语言的 Telegram 机器人和 web 版：短课程、对话练习、单词训练、翻译器、语音转文字、照片文字翻译。\n\n打开此链接即可在机器人中获得 7 天 Premium 订阅。",
	"ja": "NERIVA を試してみてください:\n%s\n\nNERIVA は AI で言語学習を支える Telegram ボットと web 版です。短いレッスン、会話練習、単語トレーニング、翻訳、音声の文字起こし、写真内テキストの翻訳ができます。\n\nこのリンクを開くと、ボットで Premium サブスクリプションを7日間受け取れます。",
	"ko": "NERIVA를 사용해 보세요:\n%s\n\nNERIVA는 AI로 언어를 배우는 Telegram 봇과 웹 버전입니다. 짧은 레슨, 대화 연습, 단어 학습, 번역기, 음성 텍스트 변환, 사진 속 텍스트 번역을 제공합니다.\n\n이 링크를 열면 봇에서 Premium 구독 7일을 받을 수 있습니다.",
}
