...
func englishPremiumUICopy() premiumUICopy {
	return premiumUICopy{
		...
		InviteLinkText:              "Try NERIVA:\n%s\n\nNERIVA is a Telegram bot and web app for learning languages with AI: short lessons, conversation practice, vocabulary training, translator, voice-to-text, and photo text translation.\n\nOpen this link and you will receive 7 days of Premium in the bot.",
		ReferralShareText:           "Try NERIVA:\n%s\n\nNERIVA is a Telegram bot and web app for learning languages with AI: short lessons, conversation practice, vocabulary training, translator, voice-to-text, and photo text translation.\n\nOpen this link and you will receive 7 days of Premium in the bot.",
...
var premiumUICopyOverrides = map[string]premiumUICopy{
	"ru": {
		...
		InviteLinkText:              "Попробуй NERIVA:\n%s\n\nNERIVA - это Telegram-бот и веб-версия для изучения языков с AI: короткие уроки, разговорная практика, тренировка слов, переводчик, голос в текст и перевод текста с фото.\n\nОткрой эту ссылку и получи 7 дней Premium-подписки в боте.",
		ReferralShareText:           "Попробуй NERIVA:\n%s\n\nNERIVA - это Telegram-бот и веб-версия для изучения языков с AI: короткие уроки, разговорная практика, тренировка слов, переводчик, голос в текст и перевод текста с фото.\n\nОткрой эту ссылку и получи 7 дней Premium-подписки в боте.",
