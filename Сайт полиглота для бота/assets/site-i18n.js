(function () {
    ...
    const englishSparkCreativeCopy = {
        "NERIVA: Practice speaking before the moment matters": {
            ru: "NERIVA: Потренируйте речь до важного момента",
            en: "NERIVA: Practice speaking before the moment matters",
            es: "NERIVA: ensaya tu voz antes del momento importante",
            de: "NERIVA: übe das Sprechen, bevor es zählt",
            fr: "NERIVA : entraînez votre parole avant le moment clé",
            it: "NERIVA: allena il parlato prima del momento che conta",
            zh: "NERIVA：在关键时刻前练好表达",
            ja: "NERIVA：大事な場面の前に話す練習を",
            ko: "NERIVA: 중요한 순간 전에 말하기를 연습하세요",
            tg: "NERIVA: пеш аз лаҳзаи муҳим суханрониро тамрин кунед",
            uz: "NERIVA: muhim lahzadan oldin gapirishni mashq qiling",
            tt: "NERIVA: мөһим мизгелгә кадәр сөйләмне шомартыгыз",
            hy: "NERIVA․ խոսքը փորձեք կարևոր պահից առաջ",
            kk: "NERIVA: маңызды сәтке дейін сөйлеуді жаттықтырыңыз",
            ky: "NERIVA: маанилүү учурга чейин сүйлөөнү машыгыңыз",
            ka: "NERIVA: ივარჯიშეთ საუბარში, სანამ მნიშვნელოვანი მომენტი დადგება",
            uk: "NERIVA: потренуйте мовлення до важливого моменту",
            pl: "NERIVA: przećwicz mówienie, zanim nadejdzie ważny moment",
            ro: "NERIVA: exersează vorbirea înainte de momentul important",
            pt: "NERIVA: treina a fala antes do momento decisivo",
            ar: "NERIVA: تدرّب على الكلام قبل اللحظة الحاسمة",
            bn: "NERIVA: দরকারি মুহূর্তের আগেই কথা বলা ঝালিয়ে নিন",
            cs: "NERIVA: nacvičte si řeč dřív, než přijde důležitý okamžik",
            el: "NERIVA: εξασκήστε την ομιλία πριν από τη στιγμή που μετρά",
            hi: "NERIVA: ज़रूरी पल से पहले बोलना अभ्यास करें",
            hu: "NERIVA: gyakorold a beszédet a fontos pillanat előtt",
            id: "NERIVA: latih bicara sebelum momen penting tiba",
            nl: "NERIVA: oefen je spreken vóór het moment dat telt",
            sv: "NERIVA: öva talet innan stunden blir viktig",
            ta: "NERIVA: முக்கிய தருணத்திற்கு முன் பேசிப் பழகுங்கள்",
            te: "NERIVA: కీలక క్షణానికి ముందు మాట్లాడటం సాధన చేయండి",
            th: "NERIVA: ฝึกพูดให้พร้อมก่อนถึงช่วงเวลาสำคัญ",
            tl: "NERIVA: sanayin ang pagsasalita bago ang mahalagang sandali",
            tr: "NERIVA: önemli an gelmeden konuşmanı çalış",
            vi: "NERIVA: luyện nói trước khi khoảnh khắc quan trọng đến"
        },
        "Live product scenario": {
            ru: "Живой сценарий продукта", en: "Live product scenario", es: "Escenario real del producto", de: "Echtes Produktszenario", fr: "Scénario produit vivant", it: "Scenario reale del prodotto", zh: "真实产品场景", ja: "実際のプロダクト場面", ko: "실제 제품 시나리오", tg: "Сенарияи зиндаи маҳсулот", uz: "Mahsulotdagi jonli ssenariy", tt: "Продукттагы тере сценарий", hy: "Ապրանքի կենդանի սցենար", kk: "Өнімдегі тірі сценарий", ky: "Продукттагы жандуу сценарий", ka: "ცოცხალი პროდუქტის სცენარი", uk: "Живий сценарій продукту", pl: "Żywy scenariusz produktu", ro: "Scenariu real de produs", pt: "Cenário real do produto", ar: "سيناريو حي داخل المنتج", bn: "পণ্যের জীবন্ত দৃশ্য", cs: "Živý scénář produktu", el: "Ζωντανό σενάριο προϊόντος", hi: "उत्पाद का जीवंत परिदृश्य", hu: "Élő termékhelyzet", id: "Skenario produk yang hidup", nl: "Levend productscript", sv: "Levande produktscenario", ta: "உயிருள்ள தயாரிப்பு நிகழ்வு", te: "ప్రొడక్ట్‌లో జీవించే దృశ్యం", th: "สถานการณ์จริงในผลิตภัณฑ์", tl: "Buhay na senaryo ng produkto", tr: "Canlı ürün senaryosu", vi: "Kịch bản sản phẩm sống động"
        },
        "Every session ends with a visible next step": {
            ru: "Каждая сессия заканчивается понятным следующим шагом", en: "Every session ends with a visible next step", es: "Cada sesión termina con el siguiente paso claro", de: "Jede Session endet mit einem klaren nächsten Schritt", fr: "Chaque séance se termine par une prochaine étape claire", it: "Ogni sessione si chiude con un passo successivo chiaro", zh: "每次练习都有清楚的下一步", ja: "毎回のセッションは次の一歩で終わります", ko: "모든 세션은 분명한 다음 단계로 끝납니다", tg: "Ҳар сессия бо қадами навбатии равшан анҷом меёбад", uz: "Har sessiya aniq keyingi qadam bilan tugaydi", tt: "Һәр сессия аңлаешлы киләсе адым белән тәмамлана", hy: "Յուրաքանչյուր սեսիա ավարտվում է հստակ հաջորդ քայլով", kk: "Әр сессия анық келесі қадаммен аяқталады", ky: "Ар бир сессия түшүнүктүү кийинки кадам менен бүтөт", ka: "ყოველი სესია მთავრდება მკაფიო შემდეგი ნაბიჯით", uk: "Кожна сесія завершується зрозумілим наступним кроком", pl: "Każda sesja kończy się jasnym kolejnym krokiem", ro: "Fiecare sesiune se încheie cu un pas următor clar", pt: "Cada sessão termina com um próximo passo claro", ar: "تنتهي كل جلسة بخطوة تالية واضحة", bn: "প্রতিটি সেশন শেষ হয় পরিষ্কার পরের ধাপে", cs: "Každá lekce končí jasným dalším krokem", el: "Κάθε συνεδρία κλείνει με καθαρό επόμενο βήμα", hi: "हर सत्र एक साफ़ अगले कदम के साथ खत्म होता है", hu: "Minden alkalom látható következő lépéssel zárul", id: "Setiap sesi berakhir dengan langkah berikut yang jelas", nl: "Elke sessie eindigt met een duidelijke volgende stap", sv: "Varje pass slutar med ett tydligt nästa steg", ta: "ஒவ்வொரு அமர்வும் தெளிவான அடுத்த படியுடன் முடிகிறது", te: "ప్రతి సెషన్ స్పష్టమైన తదుపరి అడుగుతో ముగుస్తుంది", th: "ทุกเซสชันจบด้วยขั้นตอนถัดไปที่ชัดเจน", tl: "Bawat sesyon ay may malinaw na susunod na hakbang", tr: "Her oturum görünür bir sonraki adımla biter", vi: "Mỗi buổi học khép lại bằng bước tiếp theo rõ ràng"
        },
        "NERIVA explains a phrase, asks for an answer, checks it, saves the mistake, and gives a repeatable prompt for the next review.": {
            ru: "NERIVA объясняет фразу, просит ответить, проверяет ответ, сохраняет ошибку и дает задание для следующего повторения.", en: "NERIVA explains a phrase, asks for an answer, checks it, saves the mistake, and gives a repeatable prompt for the next review.", es: "NERIVA explica una frase, pide tu respuesta, la corrige, guarda el error y prepara una práctica para el próximo repaso.", de: "NERIVA erklärt eine Formulierung, fragt deine Antwort ab, prüft sie, speichert den Fehler und gibt einen Impuls für die nächste Wiederholung.", fr: "NERIVA explique une phrase, demande une réponse, la corrige, garde l’erreur et prépare une consigne pour la prochaine révision.", it: "NERIVA spiega una frase, chiede una risposta, la controlla, salva l’errore e crea il prompt per il ripasso successivo.", zh: "NERIVA 先解释表达，再让你回答、检查答案、保存错误，并给出下次复习的练习提示。", ja: "NERIVA はフレーズを説明し、答えを求め、確認し、ミスを保存して、次の復習で使える練習を渡します。", ko: "NERIVA는 표현을 설명하고, 답을 요청하고, 확인한 뒤 실수를 저장해 다음 복습용 프롬프트로 돌려줍니다.", tg: "NERIVA ибораро мефаҳмонад, ҷавоб мехоҳад, онро месанҷад, хатогиро нигоҳ медорад ва барои такрори баъдӣ супориш медиҳад.", uz: "NERIVA iborani tushuntiradi, javob so‘raydi, tekshiradi, xatoni saqlaydi va keyingi takror uchun mashq beradi.", tt: "NERIVA фразаны аңлата, җавап сорый, тикшерә, хатаны саклый һәм киләсе кабатлау өчен бирем бирә.", hy: "NERIVA-ն բացատրում է արտահայտությունը, հարցնում է պատասխանը, ստուգում այն, պահում սխալը և հաջորդ կրկնության համար հուշում է տալիս։", kk: "NERIVA фразаны түсіндіреді, жауап сұрайды, тексереді, қатені сақтайды және келесі қайталауға тапсырма береді.", ky: "NERIVA фразаны түшүндүрөт, жооп сурайт, текшерет, катаны сактайт жана кийинки кайталоого тапшырма берет.", ka: "NERIVA განმარტავს ფრაზას, გთხოვთ პასუხს, ამოწმებს მას, ინახავს შეცდომას და შემდეგ გამეორებაზე სავარჯიშოს გაძლევთ.", uk: "NERIVA пояснює фразу, просить відповісти, перевіряє відповідь, зберігає помилку й дає завдання для наступного повторення.", pl: "NERIVA wyjaśnia frazę, prosi o odpowiedź, sprawdza ją, zapisuje błąd i daje zadanie na kolejną powtórkę.", ro: "NERIVA explică expresia, cere un răspuns, îl verifică, salvează greșeala și pregătește un exercițiu pentru recapitulare.", pt: "O NERIVA explica a frase, pede a tua resposta, verifica, guarda o erro e deixa um exercício para a próxima revisão.", ar: "تشرح NERIVA العبارة، تطلب إجابة، تراجعها، تحفظ الخطأ، ثم تمنحك تمريناً يعود في المراجعة التالية.", bn: "NERIVA একটি বাক্যাংশ বোঝায়, উত্তর চায়, তা পরীক্ষা করে, ভুলটি রাখে এবং পরের রিভিউর জন্য অনুশীলন দেয়।", cs: "NERIVA vysvětlí frázi, vyžádá si odpověď, zkontroluje ji, uloží chybu a připraví podnět pro další opakování.", el: "Το NERIVA εξηγεί τη φράση, ζητά απάντηση, τη διορθώνει, κρατά το λάθος και δίνει άσκηση για την επόμενη επανάληψη.", hi: "NERIVA वाक्यांश समझाता है, जवाब मांगता है, उसे जांचता है, गलती बचाता है और अगले रिव्यू के लिए अभ्यास देता है।", hu: "A NERIVA elmagyarázza a kifejezést, választ kér, ellenőriz, eltárolja a hibát, majd feladatot ad a következő ismétléshez.", id: "NERIVA menjelaskan frasa, meminta jawaban, memeriksa, menyimpan kesalahan, lalu memberi latihan untuk ulasan berikutnya.", nl: "NERIVA legt een zin uit, vraagt je antwoord, controleert het, bewaart de fout en geeft een oefening voor de volgende herhaling.", sv: "NERIVA förklarar frasen, ber om ett svar, kontrollerar det, sparar misstaget och ger en övning till nästa repetition.", ta: "NERIVA சொற்றொடரை விளக்கி, பதிலை கேட்டு, அதைச் சரிபார்த்து, தவறைச் சேமித்து, அடுத்த மறுபயிற்சிக்கான பயிற்சியை தருகிறது.", te: "NERIVA పదబంధాన్ని వివరిస్తుంది, సమాధానం అడుగుతుంది, దాన్ని తనిఖీ చేస్తుంది, తప్పును దాచుతుంది, తర్వాతి రివ్యూ కోసం సాధన ఇస్తుంది.", th: "NERIVA อธิบายวลี ขอคำตอบ ตรวจให้ บันทึกจุดผิด แล้วส่งโจทย์สำหรับทบทวนครั้งถัดไป", tl: "Ipinapaliwanag ng NERIVA ang parirala, hinihingi ang sagot, sinusuri ito, iniimbak ang mali, at nagbibigay ng prompt para sa susunod na review.", tr: "NERIVA ifadeyi açıklar, yanıt ister, kontrol eder, hatayı kaydeder ve bir sonraki tekrar için alıştırma verir.", vi: "NERIVA giải thích cụm từ, yêu cầu trả lời, kiểm tra, lưu lỗi và đưa bài nhắc để ôn lại lần sau."
        },
        "AI Tutor is checking the answer": {
            ru: "AI Tutor проверяет ответ", en: "AI Tutor is checking the answer", es: "AI Tutor revisa la respuesta", de: "AI Tutor prüft die Antwort", fr: "AI Tutor vérifie la réponse", it: "AI Tutor controlla la risposta", zh: "AI Tutor 正在检查答案", ja: "AI Tutor が答えを確認中", ko: "AI Tutor가 답을 확인 중입니다", tg: "AI Tutor ҷавобро месанҷад", uz: "AI Tutor javobni tekshiryapti", tt: "AI Tutor җавапны тикшерә", hy: "AI Tutor-ը ստուգում է պատասխանը", kk: "AI Tutor жауапты тексеріп жатыр", ky: "AI Tutor жоопту текшерүүдө", ka: "AI Tutor პასუხს ამოწმებს", uk: "AI Tutor перевіряє відповідь", pl: "AI Tutor sprawdza odpowiedź", ro: "AI Tutor verifică răspunsul", pt: "AI Tutor está a verificar a resposta", ar: "AI Tutor يراجع الإجابة", bn: "AI Tutor উত্তরটি যাচাই করছে", cs: "AI Tutor kontroluje odpověď", el: "Το AI Tutor ελέγχει την απάντηση", hi: "AI Tutor जवाब जांच रहा है", hu: "Az AI Tutor ellenőrzi a választ", id: "AI Tutor sedang memeriksa jawaban", nl: "AI Tutor controleert het antwoord", sv: "AI Tutor granskar svaret", ta: "AI Tutor பதிலைச் சரிபார்க்கிறது", te: "AI Tutor సమాధానాన్ని తనిఖీ చేస్తోంది", th: "AI Tutor กำลังตรวจคำตอบ", tl: "Sinusuri ng AI Tutor ang sagot", tr: "AI Tutor yanıtı kontrol ediyor", vi: "AI Tutor đang kiểm tra câu trả lời"
        },
        "weak word fixed": {
            ru: "слабое слово исправлено", en: "weak word fixed", es: "palabra débil corregida", de: "schwaches Wort sitzt", fr: "mot fragile corrigé", it: "parola debole corretta", zh: "薄弱词已修正", ja: "苦手な語を修正", ko: "약한 단어 수정됨", tg: "калимаи суст ислоҳ шуд", uz: "zaif so‘z tuzatildi", tt: "зәгыйфь сүз төзәтелде", hy: "թույլ բառը շտկվեց", kk: "әлсіз сөз түзетілді", ky: "алсыз сөз оңдолду", ka: "სუსტი სიტყვა გასწორდა", uk: "слабке слово виправлено", pl: "słabe słowo poprawione", ro: "cuvântul slab a fost corectat", pt: "palavra fraca corrigida", ar: "تم إصلاح الكلمة الضعيفة", bn: "দুর্বল শব্দ ঠিক হয়েছে", cs: "slabé slovo opraveno", el: "διορθώθηκε η αδύναμη λέξη", hi: "कमज़ोर शब्द सुधरा", hu: "gyenge szó javítva", id: "kata lemah diperbaiki", nl: "zwak woord hersteld", sv: "svagt ord fixat", ta: "பலவீனமான சொல் சரிசெய்யப்பட்டது", te: "బలహీన పదం సరిచేసింది", th: "แก้คำที่ยังอ่อนแล้ว", tl: "naayos ang mahinang salita", tr: "zayıf kelime düzeldi", vi: "từ yếu đã được sửa"
        },
        "translation saved": {
            ru: "перевод сохранен", en: "translation saved", es: "traducción guardada", de: "Übersetzung gespeichert", fr: "traduction enregistrée", it: "traduzione salvata", zh: "翻译已保存", ja: "翻訳を保存しました", ko: "번역 저장됨", tg: "тарҷума нигоҳ дошта шуд", uz: "tarjima saqlandi", tt: "тәрҗемә сакланды", hy: "թարգմանությունը պահպանվեց", kk: "аударма сақталды", ky: "котормо сакталды", ka: "თარგმანი შენახულია", uk: "переклад збережено", pl: "tłumaczenie zapisane", ro: "traducere salvată", pt: "tradução guardada", ar: "تم حفظ الترجمة", bn: "অনুবাদ সংরক্ষিত", cs: "překlad uložen", el: "η μετάφραση αποθηκεύτηκε", hi: "अनुवाद सेव हुआ", hu: "fordítás mentve", id: "terjemahan disimpan", nl: "vertaling opgeslagen", sv: "översättning sparad", ta: "மொழிபெயர்ப்பு சேமிக்கப்பட்டது", te: "అనువాదం సేవ్ అయింది", th: "บันทึกคำแปลแล้ว", tl: "naisave ang salin", tr: "çeviri kaydedildi", vi: "đã lưu bản dịch"
        },
        "Four tools, one learning profile": {
            ru: "Четыре инструмента, один учебный профиль", en: "Four tools, one learning profile", es: "Cuatro herramientas, un solo perfil de aprendizaje", de: "Vier Werkzeuge, ein Lernprofil", fr: "Quatre outils, un seul profil d’apprentissage", it: "Quattro strumenti, un profilo di studio", zh: "四个工具，一个学习档案", ja: "4つのツールを1つの学習プロフィールで", ko: "네 가지 도구, 하나의 학습 프로필", tg: "Чор абзор, як профили омӯзиш", uz: "To‘rt vosita, bitta o‘quv profili", tt: "Дүрт корал, бер уку профиле", hy: "Չորս գործիք, մեկ ուսումնական պրոֆիլ", kk: "Төрт құрал, бір оқу профилі", ky: "Төрт курал, бир окуу профили", ka: "ოთხი ინსტრუმენტი, ერთი სასწავლო პროფილი", uk: "Чотири інструменти, один навчальний профіль", pl: "Cztery narzędzia, jeden profil nauki", ro: "Patru instrumente, un singur profil de învățare", pt: "Quatro ferramentas, um só perfil de aprendizagem", ar: "أربع أدوات وملف تعلّم واحد", bn: "চারটি টুল, এক শেখার প্রোফাইল", cs: "Čtyři nástroje, jeden studijní profil", el: "Τέσσερα εργαλεία, ένα προφίλ μάθησης", hi: "चार टूल, एक सीखने वाला प्रोफ़ाइल", hu: "Négy eszköz, egy tanulási profil", id: "Empat alat, satu profil belajar", nl: "Vier tools, één leerprofiel", sv: "Fyra verktyg, en lärprofil", ta: "நான்கு கருவிகள், ஒரு கற்றல் சுயவிவரம்", te: "నాలుగు టూల్స్, ఒకే లెర్నింగ్ ప్రొఫైల్", th: "สี่เครื่องมือ หนึ่งโปรไฟล์การเรียน", tl: "Apat na tool, isang learning profile", tr: "Dört araç, tek öğrenme profili", vi: "Bốn công cụ, một hồ sơ học tập"
        },
        "Payment is available through Telegram Stars and YooKassa/SBP.": {
            ru: "Оплата доступна через Telegram Stars и YooKassa/SBP.", en: "Payment is available through Telegram Stars and YooKassa/SBP.", es: "Puedes pagar con Telegram Stars y YooKassa/SBP.", de: "Zahlung ist über Telegram Stars und YooKassa/SBP möglich.", fr: "Le paiement est disponible via Telegram Stars et YooKassa/SBP.", it: "Puoi pagare con Telegram Stars e YooKassa/SBP.", zh: "可通过 Telegram Stars 和 YooKassa/SBP 付款。", ja: "支払いは Telegram Stars と YooKassa/SBP に対応しています。", ko: "결제는 Telegram Stars 및 YooKassa/SBP로 가능합니다.", tg: "Пардохт тавассути Telegram Stars ва YooKassa/SBP дастрас аст.", uz: "To‘lov Telegram Stars va YooKassa/SBP orqali mavjud.", tt: "Түләү Telegram Stars һәм YooKassa/SBP аша мөмкин.", hy: "Վճարումը հասանելի է Telegram Stars և YooKassa/SBP-ով։", kk: "Төлем Telegram Stars және YooKassa/SBP арқылы қолжетімді.", ky: "Төлөм Telegram Stars жана YooKassa/SBP аркылуу жеткиликтүү.", ka: "გადახდა ხელმისაწვდომია Telegram Stars-ით და YooKassa/SBP-ით.", uk: "Оплата доступна через Telegram Stars і YooKassa/SBP.", pl: "Płatność jest dostępna przez Telegram Stars oraz YooKassa/SBP.", ro: "Plata este disponibilă prin Telegram Stars și YooKassa/SBP.", pt: "O pagamento está disponível por Telegram Stars e YooKassa/SBP.", ar: "الدفع متاح عبر Telegram Stars وYooKassa/SBP.", bn: "Telegram Stars ও YooKassa/SBP দিয়ে পেমেন্ট করা যায়।", cs: "Platba je dostupná přes Telegram Stars a YooKassa/SBP.", el: "Η πληρωμή γίνεται μέσω Telegram Stars και YooKassa/SBP.", hi: "भुगतान Telegram Stars और YooKassa/SBP से उपलब्ध है।", hu: "A fizetés Telegram Stars és YooKassa/SBP útján érhető el.", id: "Pembayaran tersedia melalui Telegram Stars dan YooKassa/SBP.", nl: "Betalen kan via Telegram Stars en YooKassa/SBP.", sv: "Betalning finns via Telegram Stars och YooKassa/SBP.", ta: "Telegram Stars மற்றும் YooKassa/SBP மூலம் கட்டணம் செலுத்தலாம்.", te: "Telegram Stars మరియు YooKassa/SBP ద్వారా చెల్లింపు అందుబాటులో ఉంది.", th: "ชำระเงินได้ผ่าน Telegram Stars และ YooKassa/SBP", tl: "Available ang bayad sa Telegram Stars at YooKassa/SBP.", tr: "Ödeme Telegram Stars ve YooKassa/SBP üzerinden yapılabilir.", vi: "Có thể thanh toán qua Telegram Stars và YooKassa/SBP."
        },
        "Premium key giveaways and product updates in the NERIVA channels": {
            ru: "Розыгрыши Premium-ключей и обновления продукта в каналах NERIVA", en: "Premium key giveaways and product updates in the NERIVA channels", es: "Sorteos de claves Premium y novedades en los canales de NERIVA", de: "Premium-Key-Verlosungen und Produktupdates in den NERIVA-Kanälen", fr: "Clés Premium à gagner et nouveautés dans les canaux NERIVA", it: "Giveaway di chiavi Premium e novità nei canali NERIVA", zh: "NERIVA 频道中的 Premium 密钥抽奖与产品更新", ja: "NERIVA チャンネルで Premium キー配布と製品ニュース", ko: "NERIVA 채널의 Premium 키 이벤트와 제품 업데이트", tg: "Тӯҳфаҳои калиди Premium ва навигариҳои маҳсулот дар каналҳои NERIVA", uz: "NERIVA kanallarida Premium kalit sovrinlari va mahsulot yangiliklari", tt: "NERIVA каналларында Premium ачкычлары уйнату һәм продукт яңалыклары", hy: "Premium բանալիների խաղարկություններ և արտադրանքի նորություններ NERIVA ալիքներում", kk: "NERIVA арналарындағы Premium кілт ұтыстары және өнім жаңалықтары", ky: "NERIVA каналдарында Premium ачкычтарынын утуштары жана продукт жаңылыктары", ka: "Premium გასაღებების გათამაშება და პროდუქტის სიახლეები NERIVA-ის არხებში", uk: "Розіграші Premium-ключів і оновлення продукту в каналах NERIVA", pl: "Rozdania kluczy Premium i aktualizacje produktu w kanałach NERIVA", ro: "Giveaway-uri de chei Premium și noutăți de produs pe canalele NERIVA", pt: "Sorteios de chaves Premium e novidades do produto nos canais NERIVA", ar: "سحوبات مفاتيح Premium وتحديثات المنتج في قنوات NERIVA", bn: "NERIVA চ্যানেলে Premium key giveaway ও পণ্যের আপডেট", cs: "Soutěže o Premium klíče a novinky produktu v kanálech NERIVA", el: "Κληρώσεις κλειδιών Premium και νέα προϊόντος στα κανάλια NERIVA", hi: "NERIVA चैनलों में Premium key giveaways और उत्पाद अपडेट", hu: "Premium kulcs sorsolások és termékfrissítések a NERIVA csatornáin", id: "Giveaway kunci Premium dan pembaruan produk di kanal NERIVA", nl: "Premium-key giveaways en productupdates in de NERIVA-kanalen", sv: "Premium-nycklar och produktnyheter i NERIVA-kanalerna", ta: "NERIVA சேனல்களில் Premium key பரிசுகள் மற்றும் தயாரிப்பு புதுப்பிப்புகள்", te: "NERIVA ఛానెల్లలో Premium key giveaways మరియు ప్రొడక్ట్ అప్‌డేట్స్", th: "แจกคีย์ Premium และอัปเดตผลิตภัณฑ์ในช่อง NERIVA", tl: "Premium key giveaways at product updates sa mga channel ng NERIVA", tr: "NERIVA kanallarında Premium anahtar çekilişleri ve ürün haberleri", vi: "Tặng key Premium và cập nhật sản phẩm trên các kênh NERIVA"
        },
        "Follow the community for short lessons, product updates, and monthly Premium key giveaways.": {
            ru: "Следите за сообществом: короткие уроки, обновления продукта и ежемесячные розыгрыши Premium-ключей.", en: "Follow the community for short lessons, product updates, and monthly Premium key giveaways.", es: "Únete a la comunidad para recibir lecciones breves, novedades y sorteos mensuales de claves Premium.", de: "Folge der Community für kurze Lektionen, Produktupdates und monatliche Premium-Key-Verlosungen.", fr: "Suivez la communauté pour des mini-leçons, les nouveautés et des clés Premium à gagner chaque mois.", it: "Segui la community per lezioni brevi, novità e giveaway mensili di chiavi Premium.", zh: "关注社区，获取短课、产品更新和每月 Premium 密钥抽奖。", ja: "コミュニティで短いレッスン、製品ニュース、毎月の Premium キー配布を受け取れます。", ko: "커뮤니티에서 짧은 레슨, 제품 소식, 매월 Premium 키 이벤트를 확인하세요.", tg: "Ба ҷомеа пайваст шавед: дарсҳои кӯтоҳ, навигариҳо ва тӯҳфаҳои моҳонаи калиди Premium.", uz: "Hamjamiyatni kuzating: qisqa darslar, yangiliklar va oylik Premium kalit sovrinlari.", tt: "Җәмгыятьне күзәтегез: кыска дәресләр, яңалыклар һәм ай саен Premium ачкычлары уйнату.", hy: "Հետևեք համայնքին՝ կարճ դասերի, արտադրանքի թարմացումների և ամսական Premium բանալիների համար։", kk: "Қауымдастыққа жазылыңыз: қысқа сабақтар, өнім жаңалықтары және ай сайынғы Premium кілт ұтыстары.", ky: "Коомчулукту көзөмөлдөңүз: кыска сабактар, жаңылыктар жана ай сайын Premium ачкыч утуштары.", ka: "გამოიწერეთ საზოგადოება მოკლე გაკვეთილებისთვის, სიახლეებისთვის და ყოველთვიური Premium გასაღებების გათამაშებისთვის.", uk: "Стежте за спільнотою: короткі уроки, оновлення продукту й щомісячні розіграші Premium-ключів.", pl: "Obserwuj społeczność: krótkie lekcje, aktualizacje i comiesięczne rozdania kluczy Premium.", ro: "Urmărește comunitatea pentru lecții scurte, noutăți și giveaway-uri lunare de chei Premium.", pt: "Segue a comunidade para lições curtas, novidades e sorteios mensais de chaves Premium.", ar: "تابع المجتمع للدروس القصيرة وتحديثات المنتج وسحوبات مفاتيح Premium الشهرية.", bn: "ছোট পাঠ, পণ্যের আপডেট ও মাসিক Premium key giveaway পেতে কমিউনিটি অনুসরণ করুন।", cs: "Sledujte komunitu kvůli krátkým lekcím, novinkám a měsíčním soutěžím o Premium klíče.", el: "Ακολουθήστε την κοινότητα για σύντομα μαθήματα, νέα προϊόντος και μηνιαίες κληρώσεις κλειδιών Premium.", hi: "छोटे पाठ, उत्पाद अपडेट और मासिक Premium key giveaways के लिए समुदाय को फ़ॉलो करें।", hu: "Kövesd a közösséget rövid leckékért, termékfrissítésekért és havi Premium kulcs sorsolásokért.", id: "Ikuti komunitas untuk pelajaran singkat, update produk, dan giveaway kunci Premium bulanan.", nl: "Volg de community voor korte lessen, productupdates en maandelijkse Premium-key giveaways.", sv: "Följ communityn för korta lektioner, produktnyheter och månatliga Premium-nycklar.", ta: "குறுகிய பாடங்கள், புதுப்பிப்புகள், மாதாந்திர Premium key பரிசுகளுக்காக சமூகத்தைப் பின்தொடருங்கள்.", te: "చిన్న పాఠాలు, ప్రొడక్ట్ అప్‌డేట్స్, నెలవారీ Premium key giveaways కోసం కమ్యూనిటీని అనుసరించండి.", th: "ติดตามชุมชนเพื่อรับบทเรียนสั้น อัปเดตผลิตภัณฑ์ และลุ้นคีย์ Premium ทุกเดือน", tl: "Sundan ang community para sa maiikling aralin, product updates, at buwanang Premium key giveaways.", tr: "Kısa dersler, ürün haberleri ve aylık Premium anahtar çekilişleri için topluluğu takip et.", vi: "Theo dõi cộng đồng để nhận bài học ngắn, cập nhật sản phẩm và quà tặng key Premium hằng tháng."
        },
        "Community": {
            ru: "Сообщество", en: "Community", es: "Comunidad", de: "Community", fr: "Communauté", it: "Community", zh: "社区", ja: "コミュニティ", ko: "커뮤니티", tg: "Ҷомеа", uz: "Hamjamiyat", tt: "Җәмгыять", hy: "Համայնք", kk: "Қауымдастық", ky: "Коомчулук", ka: "საზოგადოება", uk: "Спільнота", pl: "Społeczność", ro: "Comunitate", pt: "Comunidade", ar: "المجتمع", bn: "কমিউনিটি", cs: "Komunita", el: "Κοινότητα", hi: "समुदाय", hu: "Közösség", id: "Komunitas", nl: "Community", sv: "Community", ta: "சமூகம்", te: "కమ్యూనిటీ", th: "ชุมชน", tl: "Komunidad", tr: "Topluluk", vi: "Cộng đồng"
        },
        "phrase": {
            ru: "фраза", en: "phrase", es: "frase", de: "Phrase", fr: "phrase", it: "frase", zh: "短语", ja: "フレーズ", ko: "표현", tg: "ибора", uz: "ibora", tt: "фраза", hy: "արտահայտություն", kk: "фраза", ky: "фраза", ka: "ფრაზა", uk: "фраза", pl: "fraza", ro: "expresie", pt: "frase", ar: "عبارة", bn: "বাক্যাংশ", cs: "fráze", el: "φράση", hi: "वाक्यांश", hu: "kifejezés", id: "frasa", nl: "zin", sv: "fras", ta: "சொற்றொடர்", te: "పదబంధం", th: "วลี", tl: "parirala", tr: "ifade", vi: "cụm từ"
        },
        "answer": {
            ru: "ответ", en: "answer", es: "respuesta", de: "Antwort", fr: "réponse", it: "risposta", zh: "回答", ja: "回答", ko: "답변", tg: "ҷавоб", uz: "javob", tt: "җавап", hy: "պատասխան", kk: "жауап", ky: "жооп", ka: "პასუხი", uk: "відповідь", pl: "odpowiedź", ro: "răspuns", pt: "resposta", ar: "إجابة", bn: "উত্তর", cs: "odpověď", el: "απάντηση", hi: "जवाब", hu: "válasz", id: "jawaban", nl: "antwoord", sv: "svar", ta: "பதில்", te: "సమాధానం", th: "คำตอบ", tl: "sagot", tr: "yanıt", vi: "câu trả lời"
        },
        "correction": {
            ru: "исправление", en: "correction", es: "corrección", de: "Korrektur", fr: "correction", it: "correzione", zh: "纠正", ja: "修正", ko: "교정", tg: "ислоҳ", uz: "tuzatish", tt: "төзәтү", hy: "ուղղում", kk: "түзету", ky: "оңдоо", ka: "შესწორება", uk: "виправлення", pl: "korekta", ro: "corectare", pt: "correção", ar: "تصحيح", bn: "সংশোধন", cs: "oprava", el: "διόρθωση", hi: "सुधार", hu: "javítás", id: "koreksi", nl: "correctie", sv: "rättning", ta: "திருத்தம்", te: "సవరణ", th: "การแก้ไข", tl: "pagwawasto", tr: "düzeltme", vi: "sửa lỗi"
        },
        "review": {
            ru: "повторение", en: "review", es: "repaso", de: "Wiederholung", fr: "révision", it: "ripasso", zh: "复习", ja: "復習", ko: "복습", tg: "такрор", uz: "takror", tt: "кабатлау", hy: "կրկնություն", kk: "қайталау", ky: "кайталоо", ka: "გამეორება", uk: "повторення", pl: "powtórka", ro: "recapitulare", pt: "revisão", ar: "مراجعة", bn: "রিভিউ", cs: "opakování", el: "επανάληψη", hi: "दोहराव", hu: "ismétlés", id: "ulasan", nl: "herhaling", sv: "repetition", ta: "மறுபயிற்சி", te: "రివ్యూ", th: "ทบทวน", tl: "review", tr: "tekrar", vi: "ôn lại"
        },
        "Speaking practice, voice correction, and saved weak words in one loop.": {
            ru: "Разговорная практика, исправление голоса и сохраненные слабые слова в одном цикле.", en: "Speaking practice, voice correction, and saved weak words in one loop.", es: "Práctica oral, corrección de voz y palabras débiles guardadas en un mismo ciclo.", de: "Sprechpraxis, Stimmkorrektur und gespeicherte Schwachwörter in einem Ablauf.", fr: "Pratique orale, correction vocale et mots fragiles enregistrés dans une seule boucle.", it: "Pratica orale, correzione della voce e parole deboli salvate in un unico ciclo.", zh: "口语练习、语音纠正和薄弱词保存，都在同一个循环里。", ja: "スピーキング練習、音声修正、苦手語の保存を1つの流れで。", ko: "말하기 연습, 음성 교정, 약한 단어 저장을 하나의 루프로.", tg: "Машқи гуфтор, ислоҳи овоз ва калимаҳои суст дар як давра.", uz: "Gapirish mashqi, ovoz tuzatishi va saqlangan zaif so‘zlar bitta siklda.", tt: "Сөйләм практикасы, тавыш төзәтү һәм сакланган зәгыйфь сүзләр бер циклда.", hy: "Խոսքի վարժանք, ձայնային ուղղում և պահված թույլ բառեր մեկ ցիկլում։", kk: "Сөйлеу практикасы, дауыс түзету және сақталған әлсіз сөздер бір циклде.", ky: "Сүйлөө практикасы, үн оңдоо жана сакталган алсыз сөздөр бир циклде.", ka: "საუბრის პრაქტიკა, ხმის შესწორება და შენახული სუსტი სიტყვები ერთ ციკლში.", uk: "Розмовна практика, виправлення голосу й збережені слабкі слова в одному циклі.", pl: "Mówienie, korekta głosu i zapisane słabe słowa w jednej pętli.", ro: "Practică de vorbire, corectare vocală și cuvinte slabe salvate într-o singură buclă.", pt: "Prática de fala, correção de voz e palavras fracas guardadas no mesmo ciclo.", ar: "تدريب الكلام وتصحيح الصوت وحفظ الكلمات الضعيفة في حلقة واحدة.", bn: "কথা বলার অনুশীলন, ভয়েস সংশোধন ও দুর্বল শব্দ এক লুপে রাখা।", cs: "Mluvení, korekce hlasu a uložená slabá slova v jedné smyčce.", el: "Εξάσκηση ομιλίας, φωνητική διόρθωση και αδύναμες λέξεις σε έναν κύκλο.", hi: "बोलने का अभ्यास, आवाज़ सुधार और कमजोर शब्द एक ही लूप में।", hu: "Beszédgyakorlás, hangjavítás és mentett gyenge szavak egy körben.", id: "Latihan bicara, koreksi suara, dan kata lemah tersimpan dalam satu alur.", nl: "Spreekoefening, stemcorrectie en bewaarde zwakke woorden in één loop.", sv: "Talträning, röstkorrigering och sparade svaga ord i samma loop.", ta: "பேச்சுப் பயிற்சி, குரல் திருத்தம், சேமித்த பலவீனச் சொற்கள் ஒரே சுழற்சியில்.", te: "స్పీకింగ్ ప్రాక్టీస్, వాయిస్ కరెక్షన్, సేవ్ చేసిన బలహీన పదాలు ఒకే లూప్‌లో.", th: "ฝึกพูด แก้เสียง และเก็บคำที่ยังอ่อนในลูปเดียว", tl: "Speaking practice, voice correction, at naka-save na mahihinang salita sa iisang loop.", tr: "Konuşma pratiği, ses düzeltme ve kayıtlı zayıf kelimeler tek döngüde.", vi: "Luyện nói, sửa giọng và lưu từ yếu trong cùng một vòng học."
        },
        "Questions before starting": {
            ru: "Вопросы перед стартом", en: "Questions before starting", es: "Preguntas antes de empezar", de: "Fragen vor dem Start", fr: "Questions avant de commencer", it: "Domande prima di iniziare", zh: "开始前的问题", ja: "始める前の質問", ko: "시작 전 질문", tg: "Саволҳо пеш аз оғоз", uz: "Boshlashdan oldingi savollar", tt: "Башлар алдыннан сораулар", hy: "Հարցեր մեկնարկից առաջ", kk: "Бастамас бұрынғы сұрақтар", ky: "Баштоодон мурунку суроолор", ka: "კითხვები დაწყებამდე", uk: "Питання перед стартом", pl: "Pytania przed startem", ro: "Întrebări înainte de start", pt: "Perguntas antes de começar", ar: "أسئلة قبل البدء", bn: "শুরু করার আগে প্রশ্ন", cs: "Otázky před startem", el: "Ερωτήσεις πριν ξεκινήσετε", hi: "शुरू करने से पहले सवाल", hu: "Kérdések kezdés előtt", id: "Pertanyaan sebelum mulai", nl: "Vragen voor je begint", sv: "Frågor innan du börjar", ta: "தொடங்குவதற்கு முன் கேள்விகள்", te: "ప్రారంభానికి ముందు ప్రశ్నలు", th: "คำถามก่อนเริ่ม", tl: "Mga tanong bago magsimula", tr: "Başlamadan önce sorular", vi: "Câu hỏi trước khi bắt đầu"
        },
        "Open the loop and run the first lesson today": {
            ru: "Запустите цикл и начните первый урок сегодня", en: "Open the loop and run the first lesson today", es: "Abre el ciclo y haz la primera lección hoy", de: "Starte den Lernkreis und mach heute die erste Lektion", fr: "Ouvrez la boucle et lancez la première leçon aujourd’hui", it: "Apri il ciclo e fai oggi la prima lezione", zh: "今天开启学习循环，完成第一课", ja: "今日から学習ループを開き、最初のレッスンへ", ko: "오늘 학습 루프를 열고 첫 레슨을 시작하세요", tg: "Имрӯз давраро оғоз кунед ва дарси аввалро гузаронед", uz: "Bugun o‘quv siklini oching va birinchi darsni boshlang", tt: "Циклны бүген башлап, беренче дәресне үтәгез", hy: "Բացեք ցիկլը և այսօր սկսեք առաջին դասը", kk: "Бүгін циклді ашып, алғашқы сабақты бастаңыз", ky: "Бүгүн циклди ачып, биринчи сабакты баштаңыз", ka: "გახსენით ციკლი და პირველი გაკვეთილი დღესვე დაიწყეთ", uk: "Запустіть цикл і почніть перший урок сьогодні", pl: "Otwórz pętlę i zrób pierwszą lekcję już dziś", ro: "Deschide bucla și pornește prima lecție azi", pt: "Abre o ciclo e faz a primeira lição hoje", ar: "افتح الحلقة وابدأ الدرس الأول اليوم", bn: "আজই লুপ খুলে প্রথম পাঠ শুরু করুন", cs: "Otevřete smyčku a spusťte první lekci ještě dnes", el: "Ανοίξτε τον κύκλο και ξεκινήστε το πρώτο μάθημα σήμερα", hi: "लूप खोलें और आज पहला पाठ शुरू करें", hu: "Nyisd meg a kört, és indítsd el ma az első leckét", id: "Buka alurnya dan jalankan pelajaran pertama hari ini", nl: "Open de leerloop en start vandaag je eerste les", sv: "Öppna loopen och kör första lektionen i dag", ta: "சுழற்சியைத் திறந்து முதல் பாடத்தை இன்றே தொடங்குங்கள்", te: "లూప్ తెరిచి మొదటి పాఠాన్ని ఇవాళే ప్రారంభించండి", th: "เปิดลูปแล้วเริ่มบทเรียนแรกวันนี้", tl: "Buksan ang loop at simulan ang unang aralin ngayon", tr: "Döngüyü aç ve ilk dersi bugün başlat", vi: "Mở vòng học và bắt đầu bài đầu tiên ngay hôm nay"
        }
    };

    Object.assign(publicSiteFinalOverrides, englishSparkCreativeCopy, {
