...
- Added the stronger Neriva Dzen detailer v2 workflow: installed Impact Pack/Subpack plus text overlay nodes, downloaded face/hand YOLO detectors and SAM ViT-B, saved `neriva_dzen_article_visuals_detailer_v2_api.json`, and regenerated 9 article PNGs with face/hand detailer passes under `comfyui_workflows/generated/neriva_dzen_article_visuals_detailer_v2/`.
...
- Added Neriva v18 luxury-minimal outro pack with five 2-second deterministic candidates: `01_noir`, `02_ivory`, `03_platinum`, `04_gallery`, and `05_emerald`. Each uses clean `NERIVA.RU` typography, restrained motion, premium negative space, and 1080x1920/32fps output for direct comparison.
