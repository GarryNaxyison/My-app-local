...
Public website links to the web app should resolve to canonical `https://neriva.ru/app`. Legacy public hosts redirect to `neriva.ru`, so visible app URL labels and canonical metadata must not keep users on the old domains.
