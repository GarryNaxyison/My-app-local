...
1. 0-5s: Premium web app hero on laptop/tablet, presenter enters frame, logo/product identity visible.
2. 5-10s: Voice practice moment, waveform and pronunciation correction visuals.
3. 10-15s: Progress, vocabulary, mistakes review, and Telegram/web continuity.
4. 15-20s: Presenter looks confident, product/logo reveal, premium CTA mood.

## Negative Prompt

minor, underage, childlike, sensual pose, fake letters, unreadable text, random subtitles, watermark, duplicated logo, distorted logo, broken UI, cluttered background, overexposed, low quality, jpeg artifacts, static frozen scene, deformed hands, deformed face, extra limbs, noisy details, blurry product, bad composition
