...
var premiumLandingCopyByLanguage = map[string]premiumLandingCopySet{
	"ru": {
		...
		Premium: premiumLandingPlan(`Регулярная учеба`, `Основной режим для ежедневной практики: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools и расширенные дневные лимиты.`,
	...
	"en": {
		Free: premiumLandingPlan(`Try the path`, `Basic text learning, word training, Phrasebook, and progress overview. AI Tutor plus listening, pronunciation, and voice checks open in Premium.`,
		...
		Premium: premiumLandingPlan(`Regular study`, `The main mode for daily practice: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools, and expanded daily limits.`,
	...
	"es": {
		Free: premiumLandingPlan(`Probar la ruta`, `Aprendizaje básico con texto, entrenamiento de palabras, Phrasebook y resumen de progreso. AI Tutor plus listening, pronunciation y revisiones de voz se abren en Premium.`,
		...
		Premium: premiumLandingPlan(`Estudio regular`, `Modo principal para la práctica diaria: AI Tutor plus listening, pronunciation, lecciones guiadas de IA, revisiones de voz, photo tools y límites diarios ampliados.`,
	...
	"de": {
		Free: premiumLandingPlan(`Route testen`, `Grundlegendes Textlernen, Worttraining, Phrasebook und Fortschrittsüberblick. AI Tutor plus listening, pronunciation und Sprachchecks werden in Premium freigeschaltet.`,
		...
		Premium: premiumLandingPlan(`Regelmäßiges Lernen`, `Der Hauptmodus für tägliche Praxis: AI Tutor plus listening, pronunciation, geführte KI-Lektionen, voice checks, photo tools und erweiterte Tageslimits.`,
	...
	"fr": {
		Free: premiumLandingPlan(`Essayer le parcours`, `Apprentissage texte de base, entraînement des mots, Phrasebook et vue d'ensemble des progrès. AI Tutor plus listening, pronunciation et vérifications vocales s'ouvrent avec Premium.`,
		...
		Premium: premiumLandingPlan(`Étude régulière`, `Mode principal pour la pratique quotidienne : AI Tutor plus listening, pronunciation, leçons guidées par l'IA, voice checks, photo tools et limites quotidiennes élargies.`,
	...
	"it": {
		Free: premiumLandingPlan(`Prova il percorso`, `Apprendimento testuale di base, allenamento delle parole, Phrasebook e panoramica dei progressi. AI Tutor plus listening, pronunciation e controlli vocali si aprono con Premium.`,
		...
		Premium: premiumLandingPlan(`Studio regolare`, `La modalità principale per la pratica quotidiana: AI Tutor plus listening, pronunciation, lezioni guidate dall'IA, voice checks, photo tools e limiti giornalieri estesi.`,
	...
	"ko": {
		Free: premiumLandingPlan(`학습 경로 체험`, `기본 텍스트 학습, 단어 훈련, Phrasebook, 진행 상황 개요. AI Tutor plus listening, pronunciation, 음성 평가는 Premium에서 열립니다.`,
		...
		Premium: premiumLandingPlan(`정기 학습`, `매일 연습을 위한 기본 모드: AI Tutor plus listening, pronunciation, AI 가이드 레슨, voice checks, photo tools, 확장된 일일 한도.`,
	...
	"tg": {
		Free: premiumLandingPlan(`Роҳро санҷед`, `Омӯзиши асосии матнӣ, машқи калимаҳо, Phrasebook ва шарҳи пешрафт. AI Tutor plus listening, pronunciation ва санҷишҳои овозӣ дар Premium кушода мешаванд.`,
		...
		Premium: premiumLandingPlan(`Омӯзиши мунтазам`, `Режими асосӣ барои машқи ҳаррӯза: AI Tutor plus listening, pronunciation, дарсҳои роҳнамоии AI, voice checks, photo tools ва лимитҳои рӯзонаи васеъ.`,
	...
	"uz": {
		Free: premiumLandingPlan(`Marshrutni sinab ko'rish`, `Asosiy matnli o'rganish, so'z mashqi, Phrasebook va progress sharhi. AI Tutor plus listening, pronunciation va ovoz tekshiruvlari Premiumda ochiladi.`,
		...
		Premium: premiumLandingPlan(`Muntazam o'qish`, `Kundalik amaliyot uchun asosiy rejim: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools va kengaytirilgan kunlik limitlar.`,
	...
	"tt": {
		Free: premiumLandingPlan(`Маршрутны сынау`, `Төп текстлы уку, сүзләр күнегүе, Phrasebook һәм үсеш күзәтүе. AI Tutor plus listening, pronunciation һәм тавыш тикшерүләре Premiumда ачыла.`,
		...
		Premium: premiumLandingPlan(`Даими уку`, `Көндәлек практика өчен төп режим: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools һәм киңәйтелгән көнлек лимитлар.`,
	...
	"hy": {
		...
		Premium: premiumLandingPlan(`Կանոնավոր ուսուցում`, `Ամենօրյա պրակտիկայի հիմնական ռեժիմը՝ AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools և ընդլայնված օրական սահմաններ։`,
	...
	"kk": {
		Free: premiumLandingPlan(`Бағытты байқап көру`, `Негізгі мәтіндік оқу, сөз жаттығуы, Phrasebook және прогресс шолуы. AI Tutor plus listening, pronunciation және дауыс тексерулері Premium ішінде ашылады.`,
		...
		Premium: premiumLandingPlan(`Тұрақты оқу`, `Күнделікті практикаға арналған негізгі режим: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools және кеңейтілген күндік лимиттер.`,
	...
	"ky": {
		Free: premiumLandingPlan(`Маршрутту сынап көрүү`, `Негизги тексттик окуу, сөз машыгуусу, Phrasebook жана прогресс обзору. AI Tutor plus listening, pronunciation жана үн текшерүүлөр Premium ичинде ачылат.`,
		...
		Premium: premiumLandingPlan(`Туруктуу окуу`, `Күнүмдүк практика үчүн негизги режим: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools жана кеңейтилген күндүк лимиттер.`,
	...
	"ka": {
		Free: premiumLandingPlan(`მარშრუტის მოსინჯვა`, `საბაზო ტექსტური სწავლა, სიტყვების ვარჯიში, Phrasebook და პროგრესის მიმოხილვა. AI Tutor plus listening, pronunciation და ხმოვანი შემოწმებები Premium-ში იხსნება.`,
		...
		Premium: premiumLandingPlan(`რეგულარული სწავლა`, `ყოველდღიური პრაქტიკის მთავარი რეჟიმი: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools და გაფართოებული დღიური ლიმიტები.`,
	...
	"uk": {
		Free: premiumLandingPlan(`Спробувати маршрут`, `Базове текстове навчання, тренування слів, Phrasebook і огляд прогресу. AI Tutor plus listening, pronunciation і голосові перевірки відкриваються в Premium.`,
		...
		Premium: premiumLandingPlan(`Регулярне навчання`, `Основний режим для щоденної практики: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools і розширені денні ліміти.`,
	...
	"pl": {
		Free: premiumLandingPlan(`Wypróbuj ścieżkę`, `Podstawowa nauka tekstowa, trening słów, Phrasebook i przegląd postępów. AI Tutor plus listening, pronunciation i sprawdzanie głosu otwierają się w Premium.`,
		...
		Premium: premiumLandingPlan(`Regularna nauka`, `Główny tryb do codziennej praktyki: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools i rozszerzone dzienne limity.`,
	...
	"ro": {
		Free: premiumLandingPlan(`Încearcă traseul`, `Învățare text de bază, antrenament de cuvinte, Phrasebook și privire de ansamblu asupra progresului. AI Tutor plus listening, pronunciation și verificările vocale se deschid în Premium.`,
		...
		Premium: premiumLandingPlan(`Studiu regulat`, `Modul principal pentru practică zilnică: AI Tutor plus listening, pronunciation, lecții AI ghidate, voice checks, photo tools și limite zilnice extinse.`,
	...
	"pt": {
		Free: premiumLandingPlan(`Experimentar rota`, `Aprendizagem básica por texto, treino de palavras, Phrasebook e visão geral do progresso. AI Tutor plus listening, pronunciation e verificações de voz abrem no Premium.`,
		...
		Premium: premiumLandingPlan(`Estudo regular`, `Modo principal para prática diária: AI Tutor plus listening, pronunciation, aulas guiadas por IA, voice checks, photo tools e limites diários ampliados.`,
	...
	"bn": {
		Free: premiumLandingPlan(`পথটি চেষ্টা করুন`, `মৌলিক টেক্সট শেখা, শব্দ অনুশীলন, Phrasebook এবং অগ্রগতি দেখা। AI Tutor plus listening, pronunciation এবং ভয়েস চেক Premium-এ খুলবে।`,
		...
		Premium: premiumLandingPlan(`নিয়মিত শেখা`, `দৈনিক অনুশীলনের প্রধান মোড: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools এবং বাড়তি দৈনিক সীমা।`,
	...
	"cs": {
		Free: premiumLandingPlan(`Vyzkoušet trasu`, `Základní textové učení, trénink slov, Phrasebook a přehled pokroku. AI Tutor plus listening, pronunciation a hlasové kontroly se otevřou v Premium.`,
		...
		Premium: premiumLandingPlan(`Pravidelné učení`, `Hlavní režim pro každodenní praxi: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools a rozšířené denní limity.`,
	...
	"el": {
		Free: premiumLandingPlan(`Δοκιμή διαδρομής`, `Βασική μάθηση με κείμενο, εξάσκηση λέξεων, Phrasebook και επισκόπηση προόδου. AI Tutor plus listening, pronunciation και φωνητικοί έλεγχοι ανοίγουν στο Premium.`,
		...
		Premium: premiumLandingPlan(`Τακτική μελέτη`, `Ο βασικός τρόπος για καθημερινή πρακτική: AI Tutor plus listening, pronunciation, καθοδηγούμενα AI lessons, voice checks, photo tools και διευρυμένα ημερήσια όρια.`,
	...
	"hi": {
		Free: premiumLandingPlan(`मार्ग आज़माएँ`, `बुनियादी टेक्स्ट सीखना, शब्द अभ्यास, Phrasebook और प्रगति अवलोकन। AI Tutor plus listening, pronunciation और voice checks Premium में खुलते हैं।`,
		...
		Premium: premiumLandingPlan(`नियमित अध्ययन`, `दैनिक अभ्यास का मुख्य मोड: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools और बढ़ी हुई दैनिक सीमाएँ।`,
	...
	"hu": {
		Free: premiumLandingPlan(`Útvonal kipróbálása`, `Alap szöveges tanulás, szógyakorlás, Phrasebook és fejlődési áttekintés. Az AI Tutor plus listening, pronunciation és hangellenőrzések Premiumban nyílnak meg.`,
		...
		Premium: premiumLandingPlan(`Rendszeres tanulás`, `A fő mód a napi gyakorláshoz: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools és bővített napi limitek.`,
	...
	"id": {
		Free: premiumLandingPlan(`Coba jalur`, `Belajar teks dasar, latihan kata, Phrasebook, dan ringkasan progres. AI Tutor plus listening, pronunciation, dan pemeriksaan suara terbuka di Premium.`,
		...
		Premium: premiumLandingPlan(`Belajar rutin`, `Mode utama untuk praktik harian: AI Tutor plus listening, pronunciation, pelajaran AI terpandu, voice checks, photo tools, dan batas harian yang diperluas.`,
	...
	"nl": {
		Free: premiumLandingPlan(`Route proberen`, `Basis leren met tekst, woordtraining, Phrasebook en voortgangsoverzicht. AI Tutor plus listening, pronunciation en stemchecks openen in Premium.`,
		...
		Premium: premiumLandingPlan(`Regelmatig leren`, `De hoofdmodus voor dagelijkse oefening: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools en ruimere daglimieten.`,
	...
	"sv": {
		Free: premiumLandingPlan(`Prova rutten`, `Grundläggande textinlärning, ordträning, Phrasebook och översikt över framsteg. AI Tutor plus listening, pronunciation och röstkontroller öppnas i Premium.`,
		...
		Premium: premiumLandingPlan(`Regelbunden studie`, `Huvudläget för daglig träning: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools och utökade dagliga gränser.`,
	...
	"ta": {
		Free: premiumLandingPlan(`பாதையை முயற்சி செய்`, `அடிப்படை உரை கற்றல், சொல் பயிற்சி, Phrasebook மற்றும் முன்னேற்ற கண்ணோட்டம். AI Tutor plus listening, pronunciation மற்றும் குரல் சரிபார்ப்புகள் Premium-இல் திறக்கும்.`,
		...
		Premium: premiumLandingPlan(`வழக்கமான கற்றல்`, `தினசரி பயிற்சிக்கான முக்கிய முறை: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools மற்றும் விரிவான தினசரி வரம்புகள்.`,
	...
	"te": {
		Free: premiumLandingPlan(`మార్గాన్ని ప్రయత్నించండి`, `ప్రాథమిక టెక్స్ట్ అభ్యాసం, పదాల సాధన, Phrasebook మరియు పురోగతి అవలోకనం. AI Tutor plus listening, pronunciation మరియు వాయిస్ చెక్స్ Premiumలో తెరుచుకుంటాయి.`,
		...
		Premium: premiumLandingPlan(`నియమిత అభ్యాసం`, `రోజువారీ సాధనకు ప్రధాన మోడ్: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools మరియు విస్తరించిన రోజువారీ పరిమితులు.`,
	...
	"th": {
		Free: premiumLandingPlan(`ทดลองเส้นทาง`, `การเรียนด้วยข้อความพื้นฐาน ฝึกคำศัพท์ Phrasebook และภาพรวมความก้าวหน้า AI Tutor plus listening, pronunciation และการตรวจเสียงจะเปิดใน Premium`,
		...
		Premium: premiumLandingPlan(`เรียนสม่ำเสมอ`, `โหมดหลักสำหรับฝึกทุกวัน: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools และขีดจำกัดรายวันที่เพิ่มขึ้น`,
	...
	"tl": {
		Free: premiumLandingPlan(`Subukan ang ruta`, `Basic na pag-aaral sa text, word training, Phrasebook, at overview ng progreso. AI Tutor plus listening, pronunciation, at voice checks ay bukas sa Premium.`,
		...
		Premium: premiumLandingPlan(`Regular na pag-aaral`, `Pangunahing mode para sa daily practice: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools, at pinalawak na daily limits.`,
	...
	"tr": {
		Free: premiumLandingPlan(`Rotayı dene`, `Temel metinle öğrenme, kelime çalışması, Phrasebook ve ilerleme özeti. AI Tutor plus listening, pronunciation ve ses kontrolleri Premium'da açılır.`,
		...
		Premium: premiumLandingPlan(`Düzenli çalışma`, `Günlük pratik için ana mod: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools ve genişletilmiş günlük limitler.`,
	...
	"vi": {
		Free: premiumLandingPlan(`Thử lộ trình`, `Học văn bản cơ bản, luyện từ, Phrasebook và tổng quan tiến độ. AI Tutor plus listening, pronunciation và kiểm tra giọng nói mở trong Premium.`,
		...
		Premium: premiumLandingPlan(`Học đều đặn`, `Chế độ chính cho luyện tập hằng ngày: AI Tutor plus listening, pronunciation, guided AI lessons, voice checks, photo tools và giới hạn hằng ngày mở rộng.`,
