...
var compactTelegramI18n = map[string]compactTelegramTerms{
	...
	"zh": {Menu: "菜单", Stop: "停止", Back: "返回", MainMenu: "主菜单", ChooseAction: "请选择操作：", Learning: "学习", Words: "单词", Progress: "进度", Settings: "设置", Tools: "工具", NewLesson: "新课程", Practice: "练习", Listening: "听力", Level: "等级", LearnWords: "学习单词", Review: "复习", Spelling: "拼写", Vocabulary: "词汇", Mistakes: "错误", Leaders: "排行榜", Limits: "限制", BotLanguage: "机器人语言", LearningLanguage: "学习语言", Notifications: "通知", Premium: "Premium", Referrals: "邀请", ChooseBotLang: "选择机器人语言", ChooseLearnLang: "你想学哪种语言？", ChooseTimezone: "选择时区", TimezoneHint: "我会在你当地时间 19:00 左右发送每日提醒。", Ready: "完成。", UnknownButton: "我不明白这个按钮。请按菜单。", Stopped: "已停止。请按菜单选择下一步。", WordQuestion: "%s 怎么说？", ChooseAnswer: "请选择正确答案：", Correct: "正确！", TryAgain: "还不对。再试一次：", NextWord: "下一个单词", NextPage: "下一页 ▶", AlreadyLearned: "这个词已经在你的词汇中了。", AddedToVocab: "单词已加入已学词汇。", TotalLearned: "已学单词：%d", WriteWord: "写出 %s：", Hint: "提示", GoodSpelling: "拼写很棒！", VoiceToText: "语音转文字", ImageTranslate: "图片文字翻译", Translator: "翻译器", GPTAgent: "GPT 智能体", VoicePrompt: "发送语音消息，我会转成文字。", ImagePrompt: "发送含有文字的图片，我会识别并翻译。", TranslatorPrompt: "先选择语言，然后发送文本、语音或带文字的照片。", VoiceModePrompt: "发送语音消息。我会把它转成文字，不会开始练习。", ImageModePrompt: "发送含有文字的图片。我会识别并翻译。", TranslatorModePrompt: "翻译器已就绪。请选择源语言和目标语言，然后发送文本、语音或带文字的照片。", ImageOpenToolsPrompt: "要翻译图片中的文字，请打开工具并选择图片文字翻译。", ImageSinglePhotoPrompt: "请只发送1张图片。打开工具 → 图片文字翻译，发送一张不带相册的照片。", Transcript: "转写", Translation: "翻译", SourceLanguage: "源语言", TargetLanguage: "目标语言", Auto: "自动", WebApp: "Web 应用", VoiceDiscuss: "你可以用文字继续说明，我会在练习模式继续。", ImageDiscuss: "你可以再发一张照片，我会处理新图片。或者用文字说明，我会继续练习模式。", VoicePremium: "语音练习可在 Premium 中使用。", ImagePremium: "图片文字翻译可在 Premium 中使用。", VoiceLimit: "你今天的语音消息额度已用完。\n\n语音消息：%d/%d\n明天额度会自动重置。", VoiceTooLong: "语音消息太长了。\n\n最大：%d 秒\n你的消息：%d 秒", VoiceDownloadFailed: "无法下载语音消息：%s", VoiceTranscribeFailed: "无法识别语音消息：%s", VoiceTranslationFailed: "无法翻译转写内容：%s", ImageFileMissing: "找不到图片文件。请重新发送照片。", ImageDownloadFailed: "无法下载图片：%s", ImageReadFailed: "无法读取图片：%s"},
	"ja": {Menu: "メニュー", Stop: "停止", Back: "戻る", MainMenu: "メインメニュー", ChooseAction: "操作を選んでください：", Learning: "学習", Words: "単語", Progress: "進捗", Settings: "設定", Tools: "ツール", NewLesson: "新しいレッスン", Practice: "練習", Listening: "リスニング", Level: "レベル", LearnWords: "単語を学ぶ", Review: "復習", Spelling: "スペル", Vocabulary: "語彙", Mistakes: "ミス", Leaders: "ランキング", Limits: "制限", BotLanguage: "Bot の言語", LearningLanguage: "学習言語", Notifications: "通知", Premium: "Premium", Referrals: "招待", ChooseBotLang: "Bot の言語を選んでください", ChooseLearnLang: "どの言語を学びたいですか？", ChooseTimezone: "タイムゾーンを選んでください", TimezoneHint: "毎日19:00ごろにあなたの現地時間でリマインドを送ります。", Ready: "完了。", UnknownButton: "そのボタンは分かりません。メニューを押してください。", Stopped: "停止しました。次の操作はメニューを押してください。", WordQuestion: "%s は何と言いますか？", ChooseAnswer: "正しい答えを選んでください：", Correct: "正解！", TryAgain: "まだ違います。もう一度：", NextWord: "次の単語", NextPage: "次へ ▶", AlreadyLearned: "この単語はすでにあなたの語彙にあります。", AddedToVocab: "単語を学習済み語彙に追加しました。", TotalLearned: "学習済み単語：%d", WriteWord: "%s を書いてください：", Hint: "ヒント", GoodSpelling: "スペルがとても良いです！", VoiceToText: "音声をテキスト化", ImageTranslate: "画像の文字を翻訳", Translator: "翻訳", GPTAgent: "GPT エージェント", VoicePrompt: "音声メッセージを送ってください。テキストに変換します。", ImagePrompt: "文字入りの画像を送ってください。読み取って翻訳します。", TranslatorPrompt: "言語を選んでから、テキスト、音声、または文字入りの写真を送ってください。", VoiceModePrompt: "音声メッセージを送ってください。練習は開始せずに文字起こしします。", ImageModePrompt: "文字入りの画像を送ってください。読み取って翻訳します。", TranslatorModePrompt: "翻訳の準備ができました。元の言語と翻訳先の言語を選んでください。", ImageOpenToolsPrompt: "画像の文字を翻訳するには、ツールを開いて画像文字翻訳を選んでください。", ImageSinglePhotoPrompt: "画像は1枚だけ送ってください。ツール → 画像文字翻訳を開いて、アルバムではない写真を1枚送ってください。", Transcript: "書き起こし", Translation: "翻訳", SourceLanguage: "元の言語", TargetLanguage: "翻訳先", Auto: "自動", WebApp: "Webアプリ", VoiceDiscuss: "この内容はテキストでも相談できます。私は練習モードを続けます。", ImageDiscuss: "別の写真を送ることもできますし、テキストで説明してもかまいません。私は練習モードを続けます。", VoicePremium: "音声練習は Premium で利用できます。", ImagePremium: "画像の文字翻訳は Premium で利用できます。", VoiceLimit: "本日の音声メッセージ上限に達しました。\n\n音声メッセージ：%d/%d\n明日、自動で上限がリセットされます。", VoiceTooLong: "音声メッセージが長すぎます。\n\n最大：%d 秒\nあなたのメッセージ：%d 秒", VoiceDownloadFailed: "音声メッセージをダウンロードできませんでした：%s", VoiceTranscribeFailed: "音声メッセージを認識できませんでした：%s", VoiceTranslationFailed: "書き起こしを翻訳できませんでした：%s", ImageFileMissing: "画像ファイルが見つかりません。もう一度写真を送ってください。", ImageDownloadFailed: "画像をダウンロードできませんでした：%s", ImageReadFailed: "画像を読み取れませんでした：%s"},
	"ko": {Menu: "메뉴", Stop: "중지", Back: "뒤로", MainMenu: "메인 메뉴", ChooseAction: "동작을 선택하세요：", Learning: "학습", Words: "단어", Progress: "진행", Settings: "설정", Tools: "도구", NewLesson: "새 레슨", Practice: "연습", Listening: "듣기", Level: "레벨", LearnWords: "단어 학습", Review: "복습", Spelling: "철자", Vocabulary: "어휘", Mistakes: "실수", Leaders: "순위", Limits: "제한", BotLanguage: "봇 언어", LearningLanguage: "학습 언어", Notifications: "알림", Premium: "Premium", Referrals: "초대", ChooseBotLang: "봇 언어를 선택하세요", ChooseLearnLang: "어떤 언어를 배우고 싶나요？", ChooseTimezone: "시간대를 선택하세요", TimezoneHint: "매일 현지 시간으로 19:00쯤 알림을 보냅니다。", Ready: "완료。", UnknownButton: "이 버튼을 이해하지 못했습니다。메뉴를 눌러주세요。", Stopped: "중지되었습니다。다음 동작은 메뉴를 눌러주세요。", WordQuestion: "%s 는 어떻게 말하나요？", ChooseAnswer: "정답을 선택하세요：", Correct: "정답！", TryAgain: "아직 아닙니다。다시 시도하세요：", NextWord: "다음 단어", NextPage: "다음 ▶", AlreadyLearned: "이 단어는 이미 어휘에 있습니다。", AddedToVocab: "단어가 학습한 어휘에 추가되었습니다。", TotalLearned: "학습한 단어：%d", WriteWord: "%s 를 써주세요：", Hint: "힌트", GoodSpelling: "철자가 아주 좋습니다！", VoiceToText: "음성을 텍스트로", ImageTranslate: "이미지 텍스트 번역", Translator: "번역기", GPTAgent: "GPT 에이전트", VoicePrompt: "음성 메시지를 보내면 텍스트로 바꿔 드립니다。", ImagePrompt: "텍스트가 있는 이미지를 보내면 읽고 번역합니다。", TranslatorPrompt: "언어를 고른 뒤 텍스트, 음성, 또는 글자가 있는 사진을 보내세요。", VoiceModePrompt: "음성 메시지를 보내세요。연습을 시작하지 않고 텍스트로 옮깁니다。", ImageModePrompt: "텍스트가 있는 이미지를 보내세요。읽고 번역합니다。", TranslatorModePrompt: "번역기가 준비되었습니다。원문 언어와 번역 언어를 선택하세요。", ImageOpenToolsPrompt: "이미지의 텍스트를 번역하려면 도구를 열고 이미지 텍스트 번역을 선택하세요。", ImageSinglePhotoPrompt: "이미지는 한 장만 보내세요。도구 → 이미지 텍스트 번역을 열고 앨범이 아닌 사진 한 장을 보내세요。", Transcript: "전사", Translation: "번역", SourceLanguage: "원본 언어", TargetLanguage: "번역 언어", Auto: "자동", WebApp: "웹 앱", VoiceDiscuss: "이 내용은 텍스트로도 이야기할 수 있으며, 저는 연습 모드를 계속합니다。", ImageDiscuss: "다른 사진을 보내거나 텍스트로 설명할 수 있습니다。저는 연습 모드를 계속합니다。", VoicePremium: "음성 연습은 Premium에서 사용할 수 있습니다。", ImagePremium: "이미지 텍스트 번역은 Premium에서 사용할 수 있습니다。", VoiceLimit: "오늘 음성 메시지 한도에 도달했습니다。\n\n음성 메시지：%d/%d\n내일 자동으로 한도가 초기화됩니다。", VoiceTooLong: "음성 메시지가 너무 깁니다。\n\n최대：%d초\n내 메시지：%d초", VoiceDownloadFailed: "음성 메시지를 다운로드할 수 없습니다：%s", VoiceTranscribeFailed: "음성 메시지를 인식할 수 없습니다：%s", VoiceTranslationFailed: "전사 내용을 번역할 수 없습니다：%s", ImageFileMissing: "이미지 파일을 찾을 수 없습니다。사진을 다시 보내주세요。", ImageDownloadFailed: "이미지를 다운로드할 수 없습니다：%s", ImageReadFailed: "이미지를 읽을 수 없습니다：%s"},
}
