...
func compactLocalizedSystemFallback(code string) systemUICopy {
	...
	return systemUICopy{
		LessonKind: copy.NewLesson, PracticeKind: copy.Practice,
		LevelManualButton: copy.LevelTest, LevelStartButton: copy.LevelTest,
		LevelStartText:    copy.LevelTest + ": %s\n\n" + copy.MainMenuBody + " %d A1-C2.",
		ManualLevelText:   copy.LevelTest,
		LevelQuestionText: "%d/%d\n\n%s", LevelCurrentScore: "XP: %d", LevelDontKnow: "?",
		LevelManualSet: copy.LevelTest + ": %s", LevelTestSet: copy.LevelTest + ": %s",
		LessonDone:      copy.NewLesson + ". " + copy.MenuButton + ": %s",
		PracticeStarted: copy.Practice + ": %s / %s. " + copy.StopButton + ": %s",
		ReminderTitle:   copy.Notifications, ReminderStatus: "•", ReminderEnabled: "+", ReminderDisabled: "-", ReminderTimezone: copy.ChooseTimezone, ReminderDefault: "UTC", ReminderHour: "19:00", ReminderHint: copy.TimezoneHint,
		ReminderOnButton: copy.Notifications, ReminderOffButton: copy.StopButton,
		ReminderFooter:     "%s",
