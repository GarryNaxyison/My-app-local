...
const russian: LandingContent = {
  ...
  methodology: {
    ...
    body: "Вертикальная модель NERIVA показывает, как слабая фраза превращается в повтор по времени.",
    steps: [
      { label: "Фаза 01", title: "Диагностика", body: "NERIVA смотрит на цель, уровень и контекст перед выбором задания." },
      { label: "Фаза 02", title: "Правка", body: "Ответ проверяется так, как преподаватель проверяет короткую speaking-попытку." },
