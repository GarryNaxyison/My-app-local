...
const sessionPayload = {
  ...
  crypto_enabled: true,
  telegram_login_bot: "NERIVAapp_bot",
};
...
test("today plan and settings password helper copy stay localized", async ({ page }) => {
  ...
  await expect(settingsSocial.locator('a[href="https://www.youtube.com/@NERIVA"]')).toHaveAttribute("target", "_blank");
  await expect(settingsSocial.locator('a[href="https://www.youtube.com/@NERIVA"]')).toHaveAttribute("rel", "noreferrer");
